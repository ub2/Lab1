...
//            double gapX = sceneWidth-mouseEventX,
//                    gapY = scene.getHeight()-mouseEventY;
            ...
            if (MouseEvent.MOUSE_MOVED.equals(mouseEventType)) {
                ...
                Boolean isSE = mouseEventX > sceneWidth - border && mouseEventY > sceneHeight - border;
                isSE=cursorEvent.equals(Cursor.SE_RESIZE);
                if (!isSE) {
...
//                    }
//                } else {
////                  System.out.println("Lab1Gui.ResizeHelper.ResizeListener.handle()");
//                    stage.setX(mouseEvent.getScreenX() - xOffset);
//                    stage.setY(mouseEvent.getScreenY() - yOffset);
//                }
            }
